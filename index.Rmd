...
Our analysis shows Millennial who use Tinder and how many successful relationships have come out of using Tinder. In our data we see the average percentage of the outcome ____ of the relationship and how many people use Tinder as a source to finding love. The data shows ____ use Tinder, but there are very little successful relationships that come out of it. The Number of relationships without Tinder was _____, and the amount of Tinder matches/dates people had were _____. 
